...
./gradlew :app:connectedDebugAndroidTest \
  ...
  -Pandroid.testInstrumentationRunnerArguments.class=tech.zseven.rish.AndroidWorkspaceStoreTest,tech.zseven.rish.AndroidRuntimeBootstrapTest,tech.zseven.rish.AndroidWorkspaceBridgeTest,tech.zseven.rish.AndroidRuntimeStoreTest,tech.zseven.rish.AndroidCoreBindingsTest,tech.zseven.rish.AndroidWorkspaceToolExecutorTest,tech.zseven.rish.AndroidWorkspaceRegistryTest,tech.zseven.rish.AndroidPreparedAttemptStoreTest,tech.zseven.rish.AndroidAgentRootResolverTest,tech.zseven.rish.AndroidAgentRoundJournalTest,tech.zseven.rish.AndroidAgentRoundTest,tech.zseven.rish.AndroidAgentToolRegistryTest,tech.zseven.rish.AndroidAgentTranscriptStoreTest,tech.zseven.rish.AndroidAgentWalTest,tech.zseven.rish.AndroidWorkspaceToolRuleTest,tech.zseven.rish.AndroidTransportToolsTest,tech.zseven.rish.AndroidAgentToolBatchTest,tech.zseven.rish.AndroidAgentToolExecutionTest
